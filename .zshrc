...
alias s03="ssh -t ori_system_3090 'cd /media/newhd/ ; zsh --login'"
alias s04="ssh -t ori_system_4090 'cd /media/newhd/ ; zsh --login'"
alias sg="ssh -t global_4090 'cd /media/newhd/ ; zsh --login'"
alias sq="ssh -t ori_system_quadro 'cd /media/ori_quadro/newhd1/ ; zsh --login'"
